  ...
  return (
    <div className="w-full mx-auto px-1 sm:px-6 lg:px-5 py-4 flex flex-col gap-6">
      ...
      <div className="w-full bg-card rounded-sm border border-slate-200/90 shadow-sm overflow-hidden">
        <div className="border-b border-slate-200 p-4 grid grid-cols-6 gap-4">
        ...
        {[...Array(5)].map((_, i) => (
          <div key={i} className="border-b border-slate-100 p-4 grid grid-cols-6 gap-4 items-center">
